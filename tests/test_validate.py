from src.validate import validate_transaction, validate_transactions, split_valid_invalid_transactions
...
def test_split_valid_invalid_transactions():
    ...
    valid_ts, invalid_ts = split_valid_invalid_transactions(transactions)
